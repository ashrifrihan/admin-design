...
export default function sidebar() {
    ...
    const sidebarLinks = [
        ...
        { name: "Data", path: "./product.jsx", icon: overviewicon },
        { name: "Chat", path: "/chat", icon: chaticon },
    ];

  return (
    <div>
      <div className="flex flex items-center justify-between px-4 md:px-8 border-b border-gray-300 py-3 bg-white transition-all duration-300">
                <a href="/">
            ...
            <div className=" flex md:w-64 w-16 border-r h-[550px] text-base border-gray-300 pt-4 flex flex-col transition-all duration-300">
